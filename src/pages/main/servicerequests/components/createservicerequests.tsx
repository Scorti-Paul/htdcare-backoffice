...
import { createRequestProduction } from "api/mutations/production";
import { toast } from "react-toastify";

const CreateServiceRequests: FC<{}> = () => {
  ...
  const { mutateAsync, isLoading } = useMutation({
    mutationFn: (body: any) => {
      return createRequestProduction(body);
    },
    onError: (e) => {
  ...
  const handleSubmission = useCallback(
    ...
    [requestProduction, mutateAsync, navigate]
  );
      ...
      <div className="md:mt-4 md:px-12">
        <div className="px-4 sm:px-6 lg:px-8">
          <Header
            ...
            description="Fill out the details to request service."
          >
            <Button
