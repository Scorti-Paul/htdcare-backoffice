...
const Services: FC<{}> = () => {
  ...
  const columns: Column[] = [
    ...
    {
      headerText: "Period",
      keys: { type: "text", value: ["rateUnit"] },
      type: "text",
    },
    {
      headerText: "Seller's Rate",
      keys: { type: "currency", value: ["sellersPrice"] },
      type: "text",
    },
    {
      headerText: "Cost Rate",
      keys: { type: "currency", value: ["costPrice"] },
      type: "text",
    },
    {
      headerText: "Vendor",
  ...
  const { data, isFetching } = useQuery(["serviceList", page], () =>
    get("/services", {
      params: { page, limit, populate: ["vendors"] },
    })
  );
