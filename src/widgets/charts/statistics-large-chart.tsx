...
export function StatisticsLargeChart({
  color,
  chart,
  title,
  description,
...
StatisticsLargeChart.defaultProps = {
  color: 'blue',
  footer: null,
}

StatisticsLargeChart.propTypes = {
...
StatisticsLargeChart.displayName = '/src/widgets/charts/statistics-chart.jsx'

export default StatisticsLargeChart
