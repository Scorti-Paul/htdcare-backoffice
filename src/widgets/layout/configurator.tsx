    ...
    >
      <div className="flex items-start justify-between px-6 pt-8 pb-6">
        ...
        <IconButton
          variant="text"
          color="blue-gray"
          onClick={() => setOpenConfigurator(dispatch, false)} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}        >
        ...
        <div className="mb-12">
          ...
          <div className="mt-3 flex items-center gap-2">
            <Button
              ...
              onClick={() => setSidenavType(dispatch, 'dark')} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}            >
              Dark
            </Button>
            <Button
              variant={sidenavType === 'transparent' ? 'gradient' : 'outlined'}
              onClick={() => setSidenavType(dispatch, 'transparent')} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}            >
              Transparent
            </Button>
            <Button
              variant={sidenavType === 'white' ? 'gradient' : 'outlined'}
              onClick={() => setSidenavType(dispatch, 'white')} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}            >
              White
            </Button>
          </div>
        </div>
        <div className="mb-12">
          ...
          <div className="flex items-center justify-between py-5">
            ...
            <Switch
              id="navbar-fixed"
              value={fixedNavbar}
              onChange={() => setFixedNavbar(dispatch, !fixedNavbar)} crossOrigin={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}            />
          </div>
          <hr />
          <div className="my-8 flex flex-col gap-4">
            ...
            <a
              ...
              target="_black"
            >
              <Button variant="outlined" color="blue-gray" fullWidth placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                View Documentation
              </Button>
            </a>
            <a
